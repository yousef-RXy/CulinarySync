...
const uploadRecipe = async function(newRecipe) {
    try {
        const ingredients = Object.entries(newRecipe).filter((entry)=>entry[0].startsWith('ingredient') && entry[1] !== '').map((ing)=>{
            ...
            if (ingArr.length !== 3) throw new Error('Invalid ingredient format. Please use the format: Quantity,Unit,Description');
...
const KEY = 'b8ccc213-d0a8-45d8-8335-b67bd61f2166';
...
class BookmarksView extends (0, _viewJsDefault.default) {
    ...
    _errorMessage = 'No bookmarks yet. Bookmark a recipe to access it quickly.';
    _message = '';
    addHandlerRender(handler) {
...
},{"./View.js":"jSw21","url:../../img/icons.svg":"fd0vu","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["5DuvQ","7dWZ8"], "7dWZ8", "parcelRequire0573", {}, "./", "/")
